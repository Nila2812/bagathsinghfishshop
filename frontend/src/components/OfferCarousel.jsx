...
const OfferCarousel = () => {
  ...
  const title = language === "EN" ? currentOffer.title_en : currentOffer.title_ta;
  const productTitle =
    language === "EN" ? currentOffer.productTitle_en : currentOffer.productTitle_ta;
  const description =
    language === "EN" ? currentOffer.description_en : currentOffer.description_ta;
  const buttonLabel = language === "EN" ? "VIEW & ORDER" : "பார்த்து ஆர்டர் செய்யவும்";
  const sectionTitle = language === "EN" ? "SPECIAL OFFERS" : "சிறப்பு சலுகைகள்";

  return (
    <Box sx={{ py: { xs: 2, md: 3 }, px: { xs: 2, md: 4 }, backgroundColor: "#f9f9f9cd" }}>
      <Typography
        variant="h4"
        sx={{
        color: "#4E2C1E",
    ...
    transform: textAnimating
      ...
      : "translateX(0)",
          ...
          animation: textAnimating
            ? `${slideDirection === "next" ? "textSlideLeft" : "textSlideRight"} 0.8s cubic-bezier(0.4, 0, 0.2, 1)`
            : "none",
      ...
      >
           ...
           <Box
            ...
            {offers.length > 1 && (
              ...
              >
                ...
                >
                  <ArrowBackIosIcon sx={{ fontSize: { xs: "1rem", md: "1.5rem" } }} />
                </IconButton>
        ...
        {offers.length > 1 && (
          <Box sx={{ display: "flex", justifyContent: "center", gap: 1.5, mt: { xs: 2, md: 3 } }}>
            {offers.map((_, index) => (
              <Box
                key={index}
                ...
                sx={{
                  ...
                  height: 12,
                  borderRadius: "6px",
                  backgroundColor: currentSlide === index ? "#1a1a1a" : "#d0d0d0",
                  cursor: "pointer",
                  transition: "all 0.3s",
                }}
              />
